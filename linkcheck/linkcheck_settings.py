...
MAX_REDIRECT_URL_LENGTH = getattr(settings, 'LINKCHECK_MAX_REDIRECT_URL_LENGTH', MAX_URL_LENGTH)
...
FOLLOW_REDIRECT = getattr(settings, 'LINKCHECK_FOLLOW_REDIRECT', False)