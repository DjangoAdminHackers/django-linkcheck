...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Url.status'
        db.alter_column(u'linkcheck_url', 'status', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Url.status'
        db.alter_column(u'linkcheck_url', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))
